...
class sdpb_01(Scene):
    def construct(self):
        f = [
            MathTex(
                r"\begin{cases} a^{3}+b^{3}=(a+b)(a^{2}-ab+b^{2}) \\ a^{3}-b^{3}=(a-b)(a^{2}+ab+b^{2}) \end{cases}"
            ),
...
class sdpb_02(Scene):
    def construct(self):
        f = [
            ...
            MathTex(
                r"\begin{cases} \sqrt[3]{ a^{3} }=\sqrt[3]{ 125k^{3} } \\ \sqrt[3]{ b^{3} } = \sqrt[3]{ 8p^{9} }  \end{cases}"
            ),
        ...
        self.wait(1)
        self.play(TransformMatchingShapes(f[0].copy(), f[2].next_to(f[1], DOWN * 1.5)))
        for i in range(2, 5):
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f[0], f[5]), f[6].move_to(f[0]), run_time=0.7
            ),
        )
        self.wait(1)
        self.play(VGroup(f[6], f[1]).animate.move_to(ORIGIN))
...
class sdpb_03(Scene):
    def construct(self):
        f = [
            ...
            MathTex(
                r"\begin{cases} \sqrt[3]{ a^{3} }=\sqrt[3]{ 3p^{2} } \\ \sqrt[3]{ b^{3} }=\sqrt[3]{ u } \end{cases}"
            ),
            MathTex(r"\begin{cases} a=3^{1/3}p^{2/3} \\ b=u^{1/3} \end{cases}"),
            MathTex(
                r"(3^{1/3}p^{2/3}-u^{1/3})[(\sqrt[3]{ 3 }p^{2/3})^{2}+(\sqrt[3]{ 3 }p^{2/3})(\sqrt[3]{ u })+(\sqrt[3]{ u })^{2}]"
            ),
            MathTex(
                r"(3^{1/3}p^{2/3}-u^{1/3}) [3^{2/3}p^{4/3}+3^{1/3}p^{2/3}u^{1/3}+u^{2/3}]"
            ),
            MathTex(
                r"(\sqrt[3]{ 3p^{2} }-\sqrt[3]{ u })[\sqrt[3]{ 3^{2} p^{4}}+\sqrt[3]{ 3p^{2} u} +\sqrt[3]{ u^{2} }]"
            ),
        ]
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f[0], f[4].copy()), f[5].move_to(f[0]), run_time=0.7
            ),
        )
        self.wait(1)
        self.remove(f[4])
        self.play(VGroup(f[5], f[1]).animate.move_to(ORIGIN))
