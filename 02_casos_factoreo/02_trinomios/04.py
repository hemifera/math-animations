...
class fcc_02(Scene):
    def construct(self):
        f = [
            ...
            MathTex(
                r"p=\begin{cases} \frac{-53+67}{2} \\ \frac{-53-67}{2} \end{cases}"
            ),
        ...
        self.play(
            ...
            TransformMatchingShapes(f[1].copy(), f[2].shift(DOWN * 1.5)),
        )
        self.wait(1)
        self.play(
            f[2].animate.shift(LEFT * 2), Write(f[3].shift(DOWN * 1.5).shift(RIGHT * 2))
        )
        self.wait(1)
        self.play(
            TransformMatchingShapes(Group(f[2], f[3]), f[4].shift(ORIGIN).shift(DOWN))
        )
        self.wait(1)
        self.remove(f[2])
        ...
        self.play(
            TransformMatchingShapes(
                f[10], Group(f[11], f[12]).arrange(UP).move_to(f[10])
            )
        )
        self.wait(1)
...
class fcc_03(Scene):
    def construct(self):
        f = [
            ...
            MathTex(
                r"m=\begin{cases}\frac{220+430}{750} \\ \frac{220-430}{750} \end{cases}"
            ),
            ...
            MathTex(
                r"(15)\left(m-\frac{13}{15}\right)(25)\left(m+\frac{7}{25}\right)=(15)(25)0"
            ),
        ...
        self.play(TransformMatchingShapes(f[0].copy(), f[1].shift(LEFT * 4)))
        self.wait(1)
...
class fcc_05(Scene):
    def construct(self):
        ...
        self.wait(1)
        self.play(
            f[0].animate.shift(UP * 2), TransformMatchingShapes(f[0].copy(), f[1])
        )
        self.wait(1)
        ...
        self.wait(1)
        self.play(TransformMatchingShapes(f[5].copy(), f[6].next_to(f[5], RIGHT * 2)))
        self.wait(1)
        self.play(
...
class fcc_06(Scene):
    def construct(self):
        ...
        self.play(TransformMatchingShapes(Group(f[2], f[1]), f[3].shift(RIGHT * 2)))
        # self.wait(1)
        self.play(f[3].animate.move_to(ORIGIN))
        # self.remove(f[2])
        for i in range(3, 13):
        ...
        self.wait(1)
        self.play(
            f[13].animate.set_opacity(0), VGroup(f[0], f[14]).animate.arrange(DOWN)
        )
        self.wait(1)
