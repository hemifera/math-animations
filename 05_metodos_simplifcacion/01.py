...
class divl_10(Scene):
    def construct(self):
        ...
        l3 = horizontal_line(
            v0[8 + 3 + 16 * 2], v0[16 + 3 + 16 * 2], v0[13 + 16 * 2], v0[21 + 16 * 2]
        )
        ...
        self.wait()
        self.play(
            Circumscribe(f0[2][0]), Circumscribe(v0a[6].get_part_by_tex(r"x^{2}"))
        )
        self.wait()
        self.play(
            TransformMatchingShapes(
                VGroup(f0[2][0], v0[7][0]).copy(), v0a[7].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[2][0], v0[7][2]).copy(), v0a[8].set_opacity(1)
            )
        )
        self.wait()
        self.play(FadeIn(l1))
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[2][1], v0[7][0]).copy(), v0a[13].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[2][1], v0[7][2]).copy(), v0a[14].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(v0a[11], v0a[14]).copy(), v0a[16].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[2][2], v0[7][0]).copy(), v0a[18].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[2][2], v0[7][2]).copy(), v0a[19].set_opacity(1)
            )
        )
        self.wait()
        self.play(FadeIn(l3))
        ...
        self.play(FadeOut(VGroup(*v0a[:6], *v0a[7:20], l1, l2, l3)))
        self.wait()
...
class divl_20(Scene):
    def construct(self):
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[6], v0a[3][0]).copy(), v0a[4].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[6], v0a[3][1]).copy(), v0a[5].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(f0[6], v0a[3][2]).copy(), v0a[6].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(
            TransformMatchingShapes(
                VGroup(v0a[1], v0a[5]).copy(), v0a[7].set_opacity(1)
            )
        )
        self.wait()
        ...
        self.play(Circumscribe(v0a[3][0]))
        self.wait()
        self.play(FadeOut(VGroup(*v0a[:3], *v0a[4:7], l1)))
        self.wait()
        self.play(
            VGroup(v0a[3], f0[6], l01, l02).animate.shift(UP),
            VGroup(v0a[7], v0a[8], v0a[9]).animate.shift(DOWN),
        )
...
def div_line(mobject: Mobject):
    l01 = Line(
        start=[
            mobject.get_left()[0] + 0.5 * LEFT[0],
            mobject.get_bottom()[1] + 0.3 * DOWN[1],
            0,
        ],
        end=[
            mobject.get_left()[0] + 0.5 * LEFT[0],
            mobject.get_top()[1] + 0.3 * UP[1],
            0,
        ],
        color=WHITE,
    )
    l02 = Line(
        start=[
            ...
            mobject.get_right()[0] + 0.5 * RIGHT[0],
            mobject.get_top()[1] + 0.3 * UP[1],
            0,
        ],
        color=WHITE,
...
def horizontal_line(
    start_top: Mobject, start_bottom: Mobject, end_top: Mobject, end_bottom: Mobject
):
    c0 = [
